export default function Header () {
  return (
          <header
        className="header-nav fixed z-50 w-full bg-white/50 hover:bg-white backdrop-blur-md border-b border-gray-200 transition-all duration-300"
      >
              ...
              <nav className="py-3 min-h-9 flex items-center">
                <ul className="flex items-center space-x-2">
                  <li className="nav-item">
                    <a href="company/about.html" className="nav-link">Company</a>
                  </li>
                  <li className="nav-item">
                    <a href="business/ai.html" className="nav-link">Business</a>
                  </li>
                  <li className="nav-item">
                ...
                <div className="flex items-start gap-12 pb-6 pl-2">
                  <div className="submenu-section">
                    <ul className="submenu-list">
                      ...
                      <li>
                        <a href="company/organization.html" className="submenu-item"
                          >조직도</a
                        >
                      </li>
                      <li>
                        <a href="company/partnership.html" className="submenu-item"
                          >협력사</a
                        >
                      </li>
                    </ul>
                  ...
                  <div className="submenu-section">
                    <ul className="submenu-list">
                      ...
                      <li>
                        <a href="business/consulting.html" className="submenu-item"
                          >IT Consulting</a
                        >
                      </li>
                    </ul>
