...
const SYSTEM_MANAGEMENTS = [
  {
    ...
    title: "통합 운영 관리",
    description: "SLA 기반의 체계적인 수준 관리 및 정기 점검을 통한 무중단 운영 지원"
  },
  {
    icon: <MdOutlineSupportAgent className="text-secondary text-sm" />,
    title: "Help Desk 운영",
    description: "사용자 문의 신속 대응 및 기술 지원 제공, VOC 분석을 통한 서비스 개선"
  },
  {
  ...
  },
  {
    ...
    title: "성능 최적화",
    description: "DB 튜닝, 애플리케이션 리팩토링 등 지속적인 성능 개선 활동 수행"
  }
];
      ...
      <div className="max-w-5xl mx-auto px-6 py-20 flex flex-col md:flex-row gap-16 min-h-124">
        ...
        <div className="flex-1 space-y-20">
          ...
          <section>
            ...
            <p className="text-text-sub leading-relaxed mb-10 break-keep">
              시스템의 안정적인 운영을 위해 전문 인력과 체계적인 관리
              프로세스를 제공합니다. 장애 예방부터 신속한 대응, 지속적인 성능
              개선까지 고객의 IT 자산을 안전하게 보호합니다.
            </p>
...
const SMCard = ({ icon, title, description }: { icon: React.ReactNode; title: string; description: string }) => {
  return (
