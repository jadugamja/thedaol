    ...
    <section className="relative z-40 h-[calc(100vh-10rem)] lg:h-[calc(100vh-4.5rem)] grow flex items-center justify-center px-6 py-20 lg:pt-[12.5rem] lg:pb-32 overflow-hidden">
      <div className="absolute inset-0 flex items-center justify-center z-0 pointer-events-none select-none">
        ...
        <div className="relative size-100 md:size-175 lg:size-200 animate-spin-slow">
          <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[55%] h-[55%] border border-primary/20 bg-primary/5 rounded-full" />
          <div className="absolute top-1/2 right-0 -translate-y-1/2 w-[55%] h-[55%] border border-secondary/20 bg-secondary/5 rounded-full" />
          <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-[55%] h-[55%] border border-primary/20 bg-primary/5 rounded-full" />
          <div className="absolute top-1/2 left-0 -translate-y-1/2 w-[55%] h-[55%] border border-secondary/20 bg-secondary/5 rounded-full" />
          <div className="absolute inset-[25%] border border-dashed border-gray-300 rounded-full animate-spin-reverse-slow opacity-60" />
          <div className="absolute inset-[25%] border-t border-r border-primary/40 rounded-full rotate-45" />
          <div className="absolute top-[5%] left-1/2 -translate-x-1/2 w-3 h-3 bg-white border-2 border-primary rounded-full z-10" />
          <div className="absolute bottom-[5%] left-1/2 -translate-x-1/2 w-3 h-3 bg-white border-2 border-primary rounded-full z-10" />
          <div className="absolute left-[5%] top-1/2 -translate-y-1/2 w-3 h-3 bg-white border-2 border-secondary rounded-full z-10" />
          <div className="absolute right-[5%] top-1/2 -translate-y-1/2 w-3 h-3 bg-white border-2 border-secondary rounded-full z-10" />
        </div>
        <div className="absolute size-200 border border-gray-100/50 rounded-full" />
        <div className="absolute size-100 border border-primary/5 rounded-full" />
      </div>
