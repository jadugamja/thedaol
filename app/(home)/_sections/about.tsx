...
export default function HomeAbout() {
  return (
      <section
        ...
        id="about"
      >
        <div className="absolute top-20 left-80 w-64 h-64 bg-primary/5 rounded-full blur-3xl z-0"></div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <div className="text-text-sub text-lg leading-relaxed space-y-6 font-body break-keep">
                ...
                <p>
                  단순한 개발을 넘어{" "}
                  <strong className="text-text-main font-bold decoration-primary/30 underline decoration-2 underline-offset-4">
                    안정적인 SI/SM
                  </strong>{" "}
                  서비스와 <br />
                  <strong className="text-text-main font-bold decoration-primary/30 underline decoration-2 underline-offset-4">
                ...
                <p>
                  기술의 난이도가 아닌 고객이 얻게 될 가치를 최우선으로
                  생각하며 신뢰할 수 있는 파트너로서 함께 성장합니다.
                </p>
              </div>
            </div>
            <div className="relative">
              <div className="absolute top-0 -right-0 h-[29.5rem] w-full bg-gradient-to-br from-white to-gray-400/10 rounded-3xl -z-10 transform rotate-2"></div>
              <div className="relative h-[29.5rem] w-full aspect-[4/5] bg-transparent overflow-hidden rounded-3xl shadow-sm">
                <Image
                  ...
                  height={1000}
                />
                <div className="absolute top-[7.2rem] left-[10.5rem] w-1/5 h-1/6 bg-primary mix-blend-multiply opacity-80"></div>
              </div>
            </div>
          </div>
        </div>
