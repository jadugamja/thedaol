...
const PROJECTS = [
  {
    ...
    description:
      "국회 입법 프로세스의 디지털 혁신을 위한 차세대 시스템 분석 및 설계",
  ...
  },
  {
    ...
    description:
      "금융위기 청년의 신용 회복과 자산 형성을 돕는 자립 지원 플랫폼 구축",
  ...
  },
  {
    ...
    description:
      "금융 리스크 선제적 대응을 위한 자금세탁방지(AML) 모니터링 시스템 고도화",
  ...
  },
  {
    ...
    description:
      "실시간으로 수집·분석한 제조 현장의 데이터를 가상 공간에서 시뮬레이션 시스템 구축",
  ...
  },
  {
    ...
    description:
      "데이터 기반 상시 모니터링 시스템 구축 및 선제적 내부통제 시스템 고도화",
  ...
  },
  {
    ...
    description:
      "글로벌 및 국내 금융 규제 이행을 위한 정보 보고 체계 통합 고도화",
